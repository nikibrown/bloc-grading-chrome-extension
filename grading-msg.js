    ...
    if (isThinkful) {
      ...
      if (submissionTextarea) {
        ...
        if (devGrader) {
          ...
          submissionTextarea.value = 'Please select your grader type in the chrome extension' +
            ' settings';
        }
      }
    }
